...
function getPointGen() {
    ...
    if(upg('G',85) && mil('Z',43)) tet = tet.add(player.G.upgrades.length/10000)
...
var displayThings = [
    ...
    function() {
        let s='Current Endgame: eeeeee7 (7F6)'
...
function isEndgame() {
    return player.points.gte('eeeeee7')
}
