...
var displayThings = [
    ...
    function() {
        let s='Current Endgame: eeeeee5 (5F6)'
...
function isEndgame() {
    return player.points.gte('eeeeee5')
}
