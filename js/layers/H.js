addLayer("H", {
    ...
    startData() { return {
        ...
        harsh: n(0),
        hyper: n(0),
        dh:[n(0),n(0),n(0),n(0),n(0),n(0),n(0)],
        dhmax:[n(0),n(0),n(0),n(0),n(0),n(0),n(0)],
        dhp: n(0),
    }},
    passiveGeneration(){  
        let p=n(0)
    ...
    exponent() {
        ...
        exp=exp.min(min)
        if(player.Z.points.gte(48)) exp=min
        exp=exp.div(tmp.H.dhef[1] || 1).max(1e-100)//if(upg('G',144)) 
        return exp
    },
    base() {
        let b = n('e3.15e7')
        if(player.H.points.gte(15)|| player.Z.points.gte(38) ) b=n(10)
        return b
    }, 
    gainExp() {
        return n(1)
    ...
    effect(){
        ...
        if(gcs('G',123))ef=player.H.max.div(100)
        if(!upg('G',155)) ef=ef.min(20)
        if(upg('G',155)) ef=player.H.max.add(1).log(10).pow(0.5).mul(4).max(20)
        return ef
    },
    doReset(layer){
        if (layer=="I") {        
    ...
    milestones: {
        ...
        8: {requirementDescription: "5e222 dH points & e4.8e173 harsh (9",//e1e174
            done() {return player[this.layer].dhp.gte('5e222')&&player[this.layer].harsh.gte('e4.8e173') && mil('Z',38)}, 
        ...
        9: {requirementDescription: "100 H (10",
            done() {return player[this.layer].points.gte(100) && mil('Z',38)}, 
            unlocked() {return mil('Z',38)},
        ...
        10: {requirementDescription: "1e2131 dH points (11",
            done() {return player[this.layer].dhp.gte('1e2131') && mil('Z',38)}, 
            unlocked() {return mil('Z',38)},

            effectDescription: "Some dHs are cheaper.",   
        },
        11: {requirementDescription: "1e5904 dH points (12",
            done() {return player[this.layer].dhp.gte('1e5904') && mil('Z',38)}, 
            unlocked() {return mil('Z',38)},
        ...
        12: {requirementDescription: "e1.42e1886 harsh (13",
            done() {return player[this.layer].harsh.gte('e1.42e1886') && mil('Z',38)}, 
            unlocked() {return mil('Z',38)},

            effectDescription: "i eff +0.003(0.004/0.006/0.008/0.01 at e1.6e2085/e3.36e2113/e3.12e3054/e4.04e3148).",//,sb9-10 lim +200/5 at 681 H  
        },
        13: {requirementDescription: "1000 H (14",
            done() {return player[this.layer].points.gte(1000) && mil('Z',38)}, 
            unlocked() {return mil('Z',38)},

            effectDescription: "autobuy hb3/y3.",   
            toggles: [ ['H',"auto8"] ]
        },
        14: {requirementDescription: "1400 H (15",
            done() {return player[this.layer].points.gte(1400) && mil('Z',38)}, //1440 //BUT remove -1dH button
            unlocked() {return mil('Z',38)},

            effectDescription: "unlock buy all dH,reduce y4/6 sc,e nerf +0.02 at 1470.",   //1550
        },
        15: {requirementDescription: "2600 H (16",
            done() {return player[this.layer].points.gte(2600) && mil('Z',38)}, 
            unlocked() {return mil('Z',38)},
        ...
        16: {requirementDescription: "4000 H (17",
            done() {return player[this.layer].points.gte(4000) && mil('Z',38)}, 
            unlocked() {return mil('Z',38)},
        ...
        17: {requirementDescription: function(){let s="5000 H (18"
            ...
            return s},
            done() {return player[this.layer].points.gte(tmp.H.m17r) && mil('Z',38)}, 
            unlocked() {return mil('Z',38)},

            effectDescription: "buy max H,dhp4 exp is 1.5.<br>tips:base H req exp is capped at 5000.",   
        },
        18: {requirementDescription: "2e6 H (19",
            done() {return player[this.layer].points.gte(2e6) && mil('Z',38)}, 
            unlocked() {return mil('Z',38)},

            effectDescription: "G mil 36 is 0.05 at 7e6.",   
        },
    },
    m17r(){
        let r=n(5000)
    ...
    microtabs: {
        stuff: {       
            ...
            "dH": {
                ...
                ,["display-text", function() {if(upg('G',243)) return "dH7-current: <h3 style='color: #FF0000; text-shadow: 0 0 2px #c2b280'>" + format(player.H.dh[6]) + "</h3> (best:"+ format(player.H.dhmax[6]) + ")(next at "+ format(tmp.H.dhreq[6])+" GsS) boost GsS by x<h3 style='color: #FF0000; text-shadow: 0 0 2px #c2b280'>" + format(tmp.H.dhef[6],3) +"<h4>"}]
    ...
    upgrades: {
        11: {
            ...
            cost(){return n(mil('Z',42)?'ee11':mil('Z',40)?'ee9':'e2.315e8')},
        ...
        12: {
            title:'H2',
            description(){if(player.Z.points.gte(40))return "Gt13/17 are better.";return "Gt13/17 are better,unlock a new Gt."},
            cost(){return n(mil('Z',42)?'e2e11':mil('Z',40)?'e5e9':mil('Z',35)?'e1.728e9':'e2.328e8')},
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
        ...
        13: {
            ...
            cost(){return n(mil('Z',42)?'e3e11':mil('Z',40)?'e2e10':mil('Z',35)?'e2.328e9':'e2.49e8')},
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
            effect()  { 
        ...
        15: {
            title:'H5',
            description(){if(player.Z.points.gte(42))return "Gsb11-12 base +1.";if(player.Z.points.gte(40))return "keep t20,Gsb11-12 base +1.";return "keep t20,Gsb11-12 base +0.004."}, 
            cost(){return n(mil('Z',42)?'ee12':mil('Z',40)?'ee11':'e4.84e9')},
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
        ...
        21: {
            ...
            cost(){return n(mil('Z',40)?'ee13':'e1.09e12')},
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
            effect()  { 
                if(player.Z.points.gte(38))return player.H.harsh.add(10).log(10).add(10).log(10).add(10).log(10)
                let exp=n(2)
        ...
        22: {
            ...
            cost(){return n(mil('Z',38)?'e2e16':mil('Z',37)?'e7e13':mil('Z',36)?'e8.17e12':'e2.147e12')},  
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
        ...
        23: {
            ...
            cost(){return n(mil('Z',38)?'e1.4e17':mil('Z',37)?'ee14':mil('Z',36)?'e1.29e13':'e3.11e12')},  
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
            effect()  { 
        ...
        24: {
            ...
            cost(){return n(mil('Z',38)?'e8e17':mil('Z',37)?'e6e14':mil('Z',36)?'e6.85e13':'e1.84e13')},  
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
            effect()  { 
        ...
        25: {
            ...
            cost(){return n(mil('Z',38)?'e2.9e18':mil('Z',37)?'ee15':mil('Z',36)?'ee14':'e2.146e13')},  
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
        ...
        31: {
            ...
            cost(){return n(mil('Z',43)?'ee36':mil('Z',41)?'e6.9e35':mil('Z',39)?'e1.3e34':mil('Z',38)?'e4e32':'e4.5e30')},  
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
            effect()  { 
                ...
                let ef=n(getBuyableAmount('H',11)).add(10).log(10).pow(exp).sub(1).div(200)
                return ef;
            },
            effectDisplay() { return '+'+format(this.effect()) },
            unlocked() { return (upg(this.layer, 85)||mil('I',8))&& player.Z.points.gte(38)},
        },
        32: {
            title:'H12',
            description: "y1 boost y2 eff,H11 exp +0.15.",            
            cost(){return n(mil('Z',43)?'e2e36':mil('Z',41)?'ee36':mil('Z',40)?'e2e34':mil('Z',39)?'e2.6e34':mil('Z',38)?'ee33':'e1.12e31')},  
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
            effect()  { 
        ...
        33: {
            ...
            cost(){return n(mil('Z',43)?'e4e36':mil('Z',41)?'e2.6e36':mil('Z',40)?'e2.6e34':mil('Z',39)?'e3.3e34':mil('Z',38)?'ee34':'e1.46e31')},  
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
            effect()  { 
        ...
        34: {
            ...
            cost(){return n(mil('Z',43)?'e8e36':mil('Z',41)?'e3.4e36':mil('Z',40)?'e3.4e34':mil('Z',39)?'e4.4e34':mil('Z',38)?'e2e34':'e1.92e31')},  
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
            effect()  { 
        ...
        35: {
            ...
            cost(){return n(mil('Z',43)?'e16e36':mil('Z',41)?'e4.7e36':mil('Z',40)?'e4.8e34':mil('Z',39)?'e5.8e34':mil('Z',38)?'e3e34':'e2.8e31')},  
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
            effect()  { 
                let exp=n(10)
                let ef=player.H.harsh.add(10).log(10).add(10).log(10).pow(exp)
                return ef;
            },
            effectDisplay() { return '+'+format(this.effect(),3) },
        ...
        41: {
            ...
            cost(){return n(mil('Z',43)?'e32e36':mil('Z',41)?'e7.5e36':mil('Z',40)?'e7.4e34':mil('Z',39)?'e8.7e34':mil('Z',38)?'e5e34':'e4e31')},  
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
            effect()  { 
                let exp=n(10)
                let ef=player.H.hyper.add(10).log(10).add(10).log(10).pow(exp)
                let ef2=n(1)
                return [ef,ef2];
            },
            effectDisplay() { return '+'+format(this.effect()[0],3) },
            unlocked() { return (mil(this.layer, 6))},
        },
        42: {
            title:'H17',
            description: "dilate b9 by 1.02,y5 limit +2,Gsb6 boost Gsq6 and GsR.", //b8+1
            cost(){return n(mil('Z',43)?'e64e36':mil('Z',41)?'e9.5e36':mil('Z',40)?'e9.4e34':mil('Z',39)?'e1.1e35':'e6.6e34')}, 
            currencyLocation() {return player.G}, 
            currencyDisplayName: "Gse",
            currencyInternalName: "Gse",
            unlocked() { return (upg('G',142)  && mil('Z',38))},
        },
        43: {
            title:'H18',
            description: "Gr3 exp -0.01 <br>[req:1e255 GsR].", //b8+1
            cost(){return n(mil('Z',39)?'ee46':'e1.045e44')}, 
        ...
        61: {
            ...
            cost(){return n(mil('Z',43)?'1e600':mil('Z',42)?'1e484':mil('Z',41)?'1e400':mil('Z',40)?'1e300':mil('Z',39)?'1e230':mil('Z',37)?'1e200':'1e182')},
        ...
        81: {
            ...
            currencyInternalName: "harsh",
            effect()  { 
                let b=n(getBuyableAmount('G',33).div(10))
                let exp=n(0.25)
        ...
        84: {
            ...
            effect()  { 
                ...
                let ef=n(10).pow(player.G.Gsi.add(10).log(10).add(10).log(10).pow(e))
                return ef;
            },
    ...
    clickables:{
        ...
        17:{
            display(){return "+1 dH7"},
            style() {return {'background-color': layers[this.layer].clickables[this.id].canClick()?"#FF0000":"#BF8F8F",'height':'80px','min-height':'80px','width':'80px'}},
            canClick() {return n(player.G.Gss).gte(tmp.H.dhreq[6])},
            onClick() {if(n(player.G.Gss).gte(layers.H.dhreq()[6]))player.H.dh[6]=player.H.dh[6].add(1)
            },
            unlocked() {return upg('G',243)},
        },
        101:{
            ...
            onClick() {
                ...
                if(player.G.Gss.gte(tmp.H.dhreq[6])) player.H.dh[6]=player.H.dh[6].add(1)},
    ...
    automate(){
        ...
        if(upg('G',245)) layers.H.clickables[101].onClick();
    ...
    buyables:{
        11: {
            ...
            base(){   
                ...
                if(upg('G',142)||player.Z.points.gte(44)) b=player[this.layer].harsh.add(10).log(10).pow(e)
                if(upg('H',23)) b=b.pow(upgradeEffect('H',23))
                if(player.Z.points.gte(44)){
                    b=b.pow(buyableEffect('H',22)[1]);
                    return b;
                }
                let sc=n(0.6)
            ...
            effect(x) { // Effects of owning x of the items, x is a decimal
                if(player.Z.points.gte(44))return this.base().pow(x.add(this.extra()));
                let exp=n(1)
                if(upg('H',71)) exp=exp.add(0.02)
                let ef = this.base().pow(x.add(this.extra()).pow(exp))
                if(upg('H',83)) ef = this.base().pow(x.add(this.extra()).mul(buyableEffect('H',22)[1]).pow(exp))
                return ef},
            display() { // Everything else displayed in the buyable button after the title
                if(player.Z.points.gte(44))return "Harsh gain base x"+ format(this.base()) + " \n\
                ...
                return "Harsh gain base x"+ format(this.base()) + " \n\
                Cost: " + format(this.cost()) + " harsh \n\
                Amount: " + format(player[this.layer].buyables[this.id])  +" + "+ format(this.extra())+" \n\
                Effect: x" + format(this.effect())},
            unlocked() { return mil('H',2) }
		...
		if(player.Z.points.gte(41))c = n(10).pow(n(10).pow(x.pow(this.sc()).max(1).sub(1)))
                return c
            },
            sc(){
                let sc=n(0.5)
                ...
                if(mil('H',13)) s=s.min(0.7)
                let e=n(0.7).add(s)
		if(player.Z.points.gte(41))e = n(0.8)
            ...
            canAfford() { return player[this.layer].harsh.gte(this.cost()) },
            buy() {if(!upg('G',141) && player.Z.points.lt(41)) player[this.layer].harsh = player[this.layer].harsh.sub(this.cost())
                setBuyableAmount(this.layer, this.id, getBuyableAmount(this.layer, this.id).add(1))},
            base(){   let b = n(0.01)    
            ...
            effect(x) { // Effects of owning x of the items, x is a decimal
                ...
                return ef},
            display() { // Everything else displayed in the buyable button after the title
                if(player.Z.points.gte(44))return "Harsh gain base +^"+ format(this.base()) + " \n\
                Cost: " + format(this.cost()) + " harsh \n\
                Cost Factor: " + formatSmall(this.sc()) + " \n\
                Amount: " + format(player[this.layer].buyables[this.id])  +" + "+ format(this.extra())+" \n\
                Effect: ^" + format(this.effect())
                return "Harsh gain base +^"+ format(this.base()) + " \n\
                Cost: " + format(this.cost()) + " harsh \n\
                Amount: " + format(player[this.layer].buyables[this.id])  +" + "+ format(this.extra())+" \n\
                Effect: ^" + format(this.effect())},
            unlocked() { return mil('H',2) }
        ...
        13: {
            ...
            cost(x) { // cost for buying xth buyable, can be an object if there are multiple currencies
                ...
                if(player.Z.points.gte(47))c = n(10).pow(n(10).pow(x.pow(this.sc()).max(1).sub(1)))
                return c
            },
            sc(){
                if(player.Z.points.gte(47))return Decimal.div(0.5,tmp.H.dhef[5]?tmp.H.dhef[5]:1).add(1.1)
                let e=n(0.85)
                ...
                if(upg('G',154)) e=e.div(tmp.H.dhef[5]?tmp.H.dhef[5]:1)
                return e
            },  
            purchaseLimit() {let lim=n(200)
            if(player.Z.points.gte(47))return Decimal.dInf
                return lim},
            canAfford() { return player[this.layer].harsh.gte(this.cost()) },
            buy() {if(!upg('G',141) && player.Z.points.lt(47)) player[this.layer].harsh = player[this.layer].harsh.sub(this.cost())
                setBuyableAmount(this.layer, this.id, getBuyableAmount(this.layer, this.id).add(1))},
            base(){   let b = n(0.003)    
            ...
            effect(x) { // Effects of owning x of the items, x is a decimal
                ...
                return ef},
            display() { // Everything else displayed in the buyable button after the title
                if(player.Z.points.gte(47))return "dilate harsh by +"+ format(this.base()) + " \n\
                Cost: " + format(this.cost()) + " harsh \n\
                Cost Factor: " + formatSmall(this.sc()) + " \n\
        ...
        21: {
            ...
            sc(){
                ...
                let e=n(0.6).add(s)
                if(upg('G',231) || player.Z.points.gte(44))e = n(0.53)
                if(upg('H',74)) e=e.sub(0.03)
                return e
            },
            canAfford() { return player[this.layer].harsh.gte(this.cost()) },
            buy() {if(!upg('G',141) && !upg('G',231) && player.Z.points.lt(44)) player[this.layer].harsh = player[this.layer].harsh.sub(this.cost())
                setBuyableAmount(this.layer, this.id, gba(this.layer, this.id).add(1))},
            base(){   let b = n(0.008)    
                b=b.mul(n(1).add(buyableEffect('H',23)))
                return b},
            effect(x) {
                let ef = x.mul(this.base()).add(1)
                return ef},
            display() {
                if(player.Z.points.gte(44))return "Gse gain +^"+ format(this.base()) + " \n\
                Cost: " + format(this.cost()) + " harsh \n\
                Cost Factor: " + formatSmall(this.sc()) + " \n\
                Amount: " + format(player[this.layer].buyables[this.id])  +" \n\
                Effect: ^" + format(this.effect())
        ...
        22: {
            ...
            sc(){
                ...
                let e=n(0.48).add(s)
                if(player.Z.points.gte(44))e = n(0.7)
            ...
            effect(x) { // Effects of owning x of the items, x is a decimal
                ...
                let ef2= x.add(this.extra()).mul(this.base()[1]).add(1)
                return [ef,ef2]},
            display() { // Everything else displayed in the buyable button after the title
                if(player.Z.points.gte(44)) {return "Reduce Hb1 cost and Hb1 base +^"+ format(this.base()[1],3) + " \n\
                Cost: " + format(this.cost()) + " harsh \n\
                Cost Factor: " + formatSmall(this.sc()) + " \n\
                Amount: " + format(player[this.layer].buyables[this.id])  +" + "+ format(this.extra())+" \n\
                Effect: Hb1 cost factor /"+format(n(1.25).div(Decimal.pow(1.25,this.effect()[0])),3)+", Hb1 base ^" + format(this.effect()[1],3)}
                if(upg('H',83)) {return "b1 eff amt mul +"+ format(this.base()[1],3) + " \n\
                Cost: " + format(this.cost()) + " harsh \n\
                Amount: " + format(player[this.layer].buyables[this.id])  +" + "+ format(this.extra())+" \n\
                Effect: +" + format(this.effect()[1].sub(1),3)}
        ...
        51: {
            ...
            sc(){
                let e=n(0.3)
                if(upg('G',192))e=e.sub(0.07)
                if(upg('G',193))e=e.sub(0.00993)
                if(upg('G',194))e=e.sub(0.00507)
                if(mil('H',11)&&player.H.hyper.gte('e9e500')) e=e.sub(0.005)
                if(mil('G',34)) e=e.sub(0.01)
                if(upg('H',81)) e=e.div(upgradeEffect('H',81))
                if(upg('H',85)) e=e.div(1.01)
                if(upg('H',35)) e=e.div(1.03)
            ...
            buy() { if(!upg('G',141) && !upg('G',203) && player.Z.points.lt(43)) player[this.layer].hyper = player[this.layer].hyper.sub(this.cost())
                setBuyableAmount(this.layer, this.id, getBuyableAmount(this.layer, this.id).add(1))},
            base(){   
                let e=n(1.2)
		...
		if(x === undefined)x = getBuyableAmount(this.layer, this.id);
                ...
                let e=n(0.5).add(s)
		if(player.Z.points.gte(40) && (upg("G",213) || x.gte(10000)))e = n(0.7)
		if(player.Z.points.gte(41))e = n(0.7)
            ...
            canAfford() { return player[this.layer].hyper.gte(this.cost()) },
            buy() { if(!upg('G',141) && !upg('G',213) && player.Z.points.lt(46)) player[this.layer].hyper = player[this.layer].hyper.sub(this.cost())
                setBuyableAmount(this.layer, this.id, getBuyableAmount(this.layer, this.id).add(1))},
            base(){   
                let b=n(0.015)
        ...
        53: {
            ...
            cost(x) { 
                ...
                if(player.Z.points.gte(47))cost = n(10).pow(n(10).pow(x.pow(this.sc()).max(1).sub(1)))
                return cost
            },
            sc(){
                if(player.Z.points.gte(47))return Decimal.div(0.5,tmp.H.dhef[5]?tmp.H.dhef[5]:1).add(1.1)
            ...
            canAfford() { return player[this.layer].hyper.gte(this.cost()) },
            buy() { if(!upg('G',141) && player.Z.points.lt(47)) player[this.layer].hyper = player[this.layer].hyper.sub(this.cost())
                setBuyableAmount(this.layer, this.id, getBuyableAmount(this.layer, this.id).add(1))},
            base(){   
                let b=n(0.004)
            ...
            effect(x) { 
                ...
                return [ef,ef2]},
            display() { 
                if(player.Z.points.gte(47))return "dilate hyper +"+ format(this.base()) + " and Hb1 exp +"+ format(this.base2()) + "  \n\
                Cost: " + format(this.cost()) + " hyper \n\
                Cost Factor: " + formatSmall(this.sc()) + " \n\
                Amount: " + format(player[this.layer].buyables[this.id])  + " \n\
        ...
        61: {
            ...
            cost(x) { 
                ...
                if(player.Z.points.gte(48))cost = n(10).pow(n(10).pow(x.pow(this.sc()).max(1).sub(1)))
                return c
            },
            sc(){
                let e=n(0.75)
                ...
                if(player.Z.points.gte(48))return e;
                e=e.add(n(getBuyableAmount(this.layer, this.id)).sub(40).max(0).pow(0.5).div(40).min(0.75))
                e=e.add(n(getBuyableAmount(this.layer, this.id)).sub(1500).max(0).pow(0.5))
                //if(upg('H',31)) e=e.div(upgradeEffect('H',81))
                return e
            },
            canAfford() { return player[this.layer].hyper.gte(this.cost()) },
            ...
            effect(x) { 
                let ef = x.add(this.extra()).mul(this.base())
                let ef2 = x.add(this.extra()).mul(this.base2())
                if(player.Z.points.gte(48))ef2 = ef2.min(0.077)
                return [ef,ef2]},
            display() { 
                if(player.Z.points.gte(48))return "y2 1st eff +"+ format(this.base()) + " and Hb3 base +"+ format(this.base2()) + "  \n\
                Cost: " + format(this.cost()) + " hyper \n\
                Cost Factor: " + formatSmall(this.sc()) + " \n\
                Amount: " + format(player[this.layer].buyables[this.id])  +" + "+ format(this.extra())+" \n\
                Effect: y2+" + format(this.effect()[0],4) + " b3+" + format(this.effect()[1],4)+"/0.077"
        ...
        63: {
            ...
            sc(){
                ...
                if(player.Z.points.gte(48))return e.div(upg('H',35)?1.03:1);
                e=e.add(n(getBuyableAmount(this.layer, this.id)).sub(80).max(0).pow(0.5).div(50).min(0.7))
                e=e.add(n(getBuyableAmount(this.layer, this.id)).sub(3000).max(0).pow(0.5))
                if(upg('H',35)) e=e.div(1.03)
                return e
            },
            canAfford() { return player[this.layer].hyper.gte(this.cost()) },
            ...
            effect(x) { 
                ...
                return [ef,ef2]},
            display() { 
                if(player.Z.points.gte(48))return "Gs eff ^"+ format(this.base()) + " and hyper eff exp +"+ format(this.base2()) + " and provide free b2/y2  \n\
                Cost: " + format(this.cost()) + " hyper \n\
                Cost Factor: " + formatSmall(this.sc()) + " \n\
                Amount: " + format(player[this.layer].buyables[this.id])  +" \n\
        ...
        81: {
            title: "dHp1", 
            cost(x) {
                let c = n(10).pow(n(10).pow(x.pow(this.sc()).max(1).sub(1)).mul(0.5))
                if(player.Z.points.gte(48))cost = n(3.1).pow(n(10).pow(x.pow(this.sc()).max(1).sub(1)))
                return c
            },
            sc(){
                let e=n(0.35)
            ...
            buy() { if(!mil('I',3) && player.Z.points.lt(48)) player[this.layer].dhp = player[this.layer].dhp.sub(this.cost())
                setBuyableAmount(this.layer, this.id, getBuyableAmount(this.layer, this.id).add(1))},
            base(){   
                let e=n(0.25)
        ...
        82: {
            title: "dHp2", 
            cost(x) {
                let c = n(10).pow(n(10).pow(x.pow(this.sc()).max(1).sub(1)).mul(3)).mul('2e17')
                if(player.Z.points.gte(48))cost = n(1e3).pow(n(10).pow(x.pow(this.sc()).max(1).sub(1)))
                return c
            },
            sc(){
                let e=n(0.25)
        ...
        83: {
            title: "dHp3", 
            cost(x) {
                let c = n(10).pow(n(10).pow(x.add(1).pow(this.sc()).sub(1)).mul(3)).mul('1e207')
            ...
            style() {if (this.canAfford()&&(!getBuyableAmount(this.layer, this.id).gte(this.purchaseLimit()))) return {'background-color':'#3D3A3F'}},
            unlocked() { return upg('G',145) },
        ...
        84: {
            title: "dHp4", 
            cost(x) {
                let c = n(10).pow(n(10).pow(x.add(1).pow(this.sc()).sub(1)).mul(4)).mul('1e660')
                if(player.Z.points.gte(48))cost = n(1e4).pow(n(10).pow(x.pow(this.sc()).max(1).sub(1)))
                return c
            },
            sc(){
                let e=n(0.5)
    ...
    ha(){
        ...
        if(player.Z.points.gte(43))ef = Decimal.pow(10,player.H.points);
        if(upg('G',182)&& mil('Z',36))ef=ef.mul(upgradeEffect('G',182))
        ef=ef.mul(buyableEffect('H',11))
        ef=ef.pow(buyableEffect('H',12))
        ...
        if(n(getBuyableAmount('H',33)).gte(1) && player.Z.points.lt(43)) ef=ef.mul(10)
        if(n(getBuyableAmount('H',33)).gte(2) && player.Z.points.lt(43)) ef=ef.mul(10) //tiny balance
    ...
    hy(){
        ...
        if(upg('H',84)) ef=ef.mul(upgradeEffect('H',84))
        if(mil("G",30)) ef=ef.pow(tmp.G.gsref2)
        if(upg('G',214)) ef=ef.pow(10)
        if(upg('I',0)) ef=ef.pow(1.1)
    ...
    dhreq(){
        ...
        if(player.H.dh[3].gte(240))e[3]=e[3].add(10)
        if(player.H.dh[4].gte(120))e[4]=e[4].add(10)
        if(player.H.dh[5].gte(120))e[5]=e[5].add(10)
        
        if(upg('G',243)&&player.Z.points.gte(48)){
            e=[n(2.6),n(2.6),n(2.6),n(10),n(2.6),n(2),n(1)]
            if(player.H.dh[0].gte(240))e[0]=e[0].add(10)
            if(player.H.dh[1].gte(240))e[1]=e[1].add(10)
            if(player.H.dh[3].gte(240))e[3]=e[3].add(10)
            if(player.H.dh[4].gte(240))e[4]=e[4].add(10)
        }
    
        if(upg('G',245)&&player.Z.points.gte(49)){
            e=[n(2.25),n(1.6),n(1.6),n(1),n(2.5),n(1.35),n(1)]
        }
        ...
        if(upg("G",223) && mil('Z',41))e[2] = e[2].sub(0.1)
        ...
        ef[3]=player.H.dh[3].add(3).pow(e[3]).mul(7500).add(440000).pow(3)
        ...
        if(upg('G',245)){
            ef[0]=n(10).pow(player.H.dh[0].add(1).pow(e[0]).mul(6))
            ef[1]=n(10).pow(n(10).pow(player.H.dh[1].add(1).pow(e[1]).mul(2)))
            ef[2]=n(10).pow(player.H.dh[2].add(1).pow(e[2]).mul(30))
            ef[3]=Decimal.pow(2,player.H.dh[3].add(1).pow(e[3]))
            ef[4]=n(10).pow(n(10).pow(player.H.dh[4].add(1).pow(e[4]).mul(2)))
            ef[5]=player.H.dh[5].pow(e[5]).mul(5).pow(5)
        }
        ef[6] = Decimal.pow(100,player.H.dh[6].add(10))
        return ef
    },
    totdh(){
        let s=n(0)               
        for(let i=0;i<=6;i++) s=s.add(player.H.dh[i])
        return s
    },
    dhbs(){let b=[n(5),n(15),n(5),n(25),n(25),n(100),n(100)]
        if(mil('H',8)) {b[0]=n(10),b[2]=n(10)}
        if(player.Z.points.gte(44))b=[n(100),n(100),n(100),n(100),n(100),n(100),n(100)]
        for(let i=0;i<=6;i++) b[i]=b[i].add(buyableEffect('H',84)[0])
        return b},
    dhef(){
        ...
        ef[4]=c[4].pow(e[4])
        if(mil('G',33)&&player.H.dh[4].gte(4)) {e[4]=n(1.05),ef[4]=c[4].pow(e[4])}
        ...
        ef[6]=Decimal.pow(2,player.H.dh[6])
        return ef
    },
    dhp(){
        let ef=n(5)
        let b=[n(5),n(15),n(5),n(25),n(25),n(100),n(100)]
        if(mil('H',8)) {b[0]=n(10),b[2]=n(10)}  //not 'dhbs' to avoid bugs
        if(player.Z.points.gte(44))b=[n(100),n(100),n(100),n(100),n(100),n(100),n(100)]
        for(let i=0;i<=6;i++) b[i]=b[i].add(buyableEffect('H',84)[0])
        for(let i=0;i<=6;i++) ef=ef.mul(n(b[i]).pow(player.H.dh[i]))  //effective!
    ...
    phpb(){
        let ef=n(100)
        if(player.Z.points.lt(50))ef = n(10)
    ...
    update(diff){
        ...
        for(let i=0;i<=6;i++) player.H.dhmax[i]=player.H.dhmax[i].max(player.H.dh[i])
